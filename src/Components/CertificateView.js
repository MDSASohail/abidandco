...
export default function CertificateView() {
  ...
  return (
    ...
    >
      <div className="h-fit bg-white rounded-lg shadow-lg w-[99%] md:[95%] mx-10 p-3 m-6">
        <div className="flex  justify-between items-center p-4">
          ...
          <img
            ...
            className="md:h-20 object-contain h-10"
          />
        </div>
        <div className="py-3 my-3 bg-[#007A5A] rounded-sm flex items-center text-white pl-10"> <span><svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
          <path stroke="currentColor" className="text-white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8.5 11.5 11 14l4-4m6 2a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
        </svg>
